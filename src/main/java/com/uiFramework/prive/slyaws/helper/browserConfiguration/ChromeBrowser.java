...
public class ChromeBrowser {
	...
	public WebDriver getChromeDriver(ChromeOptions cap) {
		...
		if (System.getProperty("os.name").contains("Mac")){
			...
			System.setProperty("webdriver.chrome.driver", ResourceHelper.getResourcePath("\\src\\main\\java\\com\\uiFramework\\prive\\slyaws\\helper\\resource\\drivers\\chromedriver.exe"));
			return new ChromeDriver(cap);
		}
